...
define('_TZ_GMTM5', '(GMT-5:00) Eastern Time (Canada), Bogota, Lima, Quito');
...
define('_TZ_GMTM1', '(GMT-1:00) Azoren, Kapverdische Inseln');
define('_TZ_GMT0', '(GMT) GMT, London, Lissabon, Monrovia');
define('_TZ_GMTP1', '(GMT+1:00) Amsterdam, Berlin, Rom, Paris, Wien');
define('_TZ_GMTP2', '(GMT+2:00) Athen, Helsinki, Jerusalem, Südafrika');
define('_TZ_GMTP3', '(GMT+3:00) Kuwait, Moskau, St. Petersburg');
...
define('_TZ_GMTP5', '(GMT+5:00) Ekaterinenburg, Islamabad, Tashkent');
define('_TZ_GMTP55', '(GMT+5:30) Bombay, Calcutta, Neu Delhi');
define('_TZ_GMTP6', '(GMT+6:00) Almaty, Dhakar, Colombo');
define('_TZ_GMTP7', '(GMT+7:00) Bangkok, Hanoi, Jakarta');
define('_TZ_GMTP8', '(GMT+8:00) Beijing, Singapur, Hong Kong, Taipei');
define('_TZ_GMTP9', '(GMT+9:00) Tokyo, Seoul, Sapporo, Yakutsk');
