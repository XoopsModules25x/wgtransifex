...
define('_MI_WGGALLERY_EXIFTYPES_DESC', "Define which exif data should be shown<br>The option 'Save meta data (exif)' must be activated");
define('_MI_WGGALLERY_EXIF_TAGS', 'Extract tags of exif');
define('_MI_WGGALLERY_EXIF_TAGS_DESC', "Define which exif data should be automatically extraced from exif and added to an image as a tag<br>The option 'Use tags' must be activated");
