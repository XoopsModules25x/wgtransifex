...
\define('_MI_WGTRANSIFEX_DOWNLOAD_TYPE', 'Download Type');
\define('_MI_WGTRANSIFEX_DOWNLOAD_TYPE_DESC', 'Define how the download of packages should be executed');
\define('_MI_WGTRANSIFEX_DOWNLOAD_TYPE_FPASSTHRU', 'Use Function fpassthru');
\define('_MI_WGTRANSIFEX_DOWNLOAD_TYPE_REDIRECT', 'Use Function redirect (if fpassthru is not working)');
