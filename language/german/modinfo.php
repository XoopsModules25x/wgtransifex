...
\define('_MI_WGTRANSIFEX_DOWNLOAD_TYPE', 'Download Typ');
\define('_MI_WGTRANSIFEX_DOWNLOAD_TYPE_DESC', 'Definiere wie der Download de Packete ausgeführt werden soll');
\define('_MI_WGTRANSIFEX_DOWNLOAD_TYPE_FPASSTHRU', 'Verwende Funktion fpassthru');
\define('_MI_WGTRANSIFEX_DOWNLOAD_TYPE_REDIRECT', 'Verwende Funktion redirect (wenn fpassthru nicht funktioniert)');
