...
\define('_AM_WGTRANSIFEX_TRANSIFEX_INFO_TITLE', 'Wichtige Information');
\define('_AM_WGTRANSIFEX_TRANSIFEX_INFO_TEXT', 'Da der Download über die Transifex API Schnittstelle nur mehr die tatsächlich übersetzten Teile zur Verfügung stellt lassen sich mit diesen Informationen keine vollständigen Übersetzungsdateien mehr erstellen.<br>Aus diesem Grund werden die englischen Originaldateien als Template verwendet und die übersetzten Teile in der Datei ersetzt.<br>Es ist daher erforderlich, dass alle englischen Sprachdateien in der aktuellen XOOPS Installation in der letztgültigen Fassung vorliegen, da es ansonsten zur Erstellung von fehlerhaften Dateien kommen kann!');
