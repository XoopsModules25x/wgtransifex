...
\define('CO_' . $moduleDirNameUpper . '_' . 'FB_FORM_TITLE', 'Ein Feedback senden');
\define('CO_' . $moduleDirNameUpper . '_' . 'FB_RECIPIENT', 'Empfänger');
\define('CO_' . $moduleDirNameUpper . '_' . 'FB_NAME', 'Name');
\define('CO_' . $moduleDirNameUpper . '_' . 'FB_NAME_PLACEHOLER', 'Bitte ergänzen Sie Ihren Namen');
\define('CO_' . $moduleDirNameUpper . '_' . 'FB_SITE', 'Website');
\define('CO_' . $moduleDirNameUpper . '_' . 'FB_SITE_PLACEHOLER', 'Bitte ergänzen Sie Ihre Website');
\define('CO_' . $moduleDirNameUpper . '_' . 'FB_MAIL', 'E-Mail');
\define('CO_' . $moduleDirNameUpper . '_' . 'FB_MAIL_PLACEHOLER', 'Bitte ergänzen Sie Ihre E-Mail');
\define('CO_' . $moduleDirNameUpper . '_' . 'FB_TYPE', 'Art des Feedbacks');
\define('CO_' . $moduleDirNameUpper . '_' . 'FB_TYPE_SUGGESTION', 'Vorschläge');
\define('CO_' . $moduleDirNameUpper . '_' . 'FB_TYPE_BUGS', 'Fehler & Bugs');
\define('CO_' . $moduleDirNameUpper . '_' . 'FB_TYPE_TESTIMONIAL', 'Empfehlungen');
...
\define('CO_' . $moduleDirNameUpper . '_' . 'FB_SEND_ERROR', 'Beim Senden des Feedbacks ist leider ein Fehler aufgetreten!');
